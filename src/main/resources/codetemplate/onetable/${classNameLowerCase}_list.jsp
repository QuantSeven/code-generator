...
<div id="${classNameLowerCase}ListGrid" data-datagrid="<#if template_type == 'model'>{singleSelect:false}</#if>" url="${classNameLowerCase}/dataGrid" >
	...
	<div class="datagrid-search">
	   <form class="form-search" style="width:100%"  >
		   	<ul>
		   		<li>
					<label><spring:message code="${classNameLowerCase}.txt.${table.columns[0].columnNameLowerCase}" />：</label>
					<input type="text" placeholder='<spring:message code="${classNameLowerCase}.txt.${table.columns[0].columnNameLowerCase}" />' name="filter_${table.columns[0].columnNameLowerCase}" /></li>
				</li>
				<li >
					<label><spring:message code="${classNameLowerCase}.txt.${table.columns[1].columnNameLowerCase}" />：</label>
					<input type="text" placeholder='<spring:message code="${classNameLowerCase}.txt.${table.columns[1].columnNameLowerCase}" />' name="filter_${table.columns[1].columnNameLowerCase}" /> 
		   		</li>
	...
	<table class="table">
		<thead>
		    <tr>
				...
				<th width="100" class="sort-header" data-code="${column}"><spring:message code="${classNameLowerCase}.txt.${column.columnNameLowerCase}" /></th> 
				</#list>
			</tr>
		</thead>
